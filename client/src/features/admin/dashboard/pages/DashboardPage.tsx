                                ...
                                <tbody className="divide-y divide-[#424656]/5">
                                    {screeningData.map((item) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-8 py-6">
                                                <span
                                                    className={`px-3 py-1 text-[10px] font-extrabold rounded-full border ${item.format === 'IMAX 4K'
                                            ...
                                            <td className="px-8 py-6 text-right">
                                                <span
                                                    className={`flex items-center justify-end gap-1.5 text-xs font-bold ${item.statusType === 'live'
                                                            ? 'text-[#0066ff]'
