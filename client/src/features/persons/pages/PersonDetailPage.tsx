...
export default function PersonDetailPage() {
  ...
  const participatedMovies: MovieResponse[] =
    (moviesData as any)?.data?.data || [];
              ...
              <div className="flex-1 flex flex-col justify-start items-start text-left pt-2 ml-4">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <p className="flex w-full items-start">
                    <span className="font-semibold text-gray-500 inline-block w-24 shrink-0">
                      Ngày sinh:
                    </span>
                    <span>
                      {person.birthDate
                  ...
                  <p className="flex w-full items-start">
                    ...
                    <span>
                      {person.height ? `${person.height} cm` : 'Đang cập nhật'}
                    </span>
                  </p>
                  <p className="flex w-full items-start">
                    <span className="font-semibold text-gray-500 inline-block w-24 shrink-0">
            ...
            <div className="mb-10">
              ...
              <Grid gutter="xl">
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {person.name} / {isActor ? 'Actor' : 'Director'}
                        </p>
                      </div>
                    </Link>
                  </Grid.Col>
                ...
                {participatedMovies.length === 0 && (
                  <div className="text-gray-400 italic ps-4">
                    Đang cập nhật...
                  </div>
                )}
              </Grid>
